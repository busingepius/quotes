...
import 'package:quoter/tab_container_screen.dart';
...
class _PathConstants {
  ...
  static String get tabControllerPath => '/';

  static String get quoteListPath => '${tabControllerPath}quotes';

  static String get profileMenuPath => '${tabControllerPath}user';

  static String get updateProfilePath => '$profileMenuPath/update-profile';

  static String get signInPath => '${tabControllerPath}sign-in';

  static String get signUpPath => '${tabControllerPath}sign-up';
...
Map<String, PageBuilder> buildRoutingTable({
  ...
  return {
    _PathConstants.tabControllerPath: (_) => CupertinoTabPage(
